 ...
 */
class Intent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Intent';
     ...
     * Sets confidence
     *
     * @param float $confidence Confidence of the intent
     *
     * @return self
     */
